...
from ..layers.template_response_fusion import TemplateResponseFusion
...
class VisionTransformerCE(VisionTransformer):
    ...
    def _apply_moe_bridge(
        ...
        route = self.moe_bridge.route_candidate_pair(rgb_bundle, tir_bundle)
        ...
        moe_meta.update({
            "aux_rgb": aux_rgb,
            "aux_tir": aux_tir,
            "router_quality_logits": route["logits"],
            "ran_moe": True,
        })
