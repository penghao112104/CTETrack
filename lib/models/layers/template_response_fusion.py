...
class TemplateResponseFusion(nn.Module):
    """Reliability-aware RGB/TIR late fusion.

    All template tokens keep their original channel dimension and interact
    with every search token to estimate token-wise modality reliability.
    """
